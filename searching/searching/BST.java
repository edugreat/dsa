...
//The BST is a data structure with at most two nodes(the left node and the right node)
//where a node has a key-value pair. Nodes to the left have keys that are less than
//keys of the parent node.
//Nodes to the right have keys that are greater than keys in the parent nodes
public class BST<Key extends Comparable<Key>, Value> {
	...
	//helper method that deletes the smallest node from a subtree
   private Node deleteMin(Node x) {
		//continue going left until a node with null left link,then return its right link
   ...
   public static void main(String[] args) {
	   ...
	   String q = "easyquestion";
	   String[] x = q.toUpperCase().split("");
